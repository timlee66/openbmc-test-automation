...
Verify Redfish User Persistence After Reboot
    ...
    Redfish Create User  user_user      TestPwd123  ReadOnly        ${True}
    ...
    Redfish Verify User  user_user      TestPwd123  ReadOnly        ${True}
...
Redfish Create and Verify Users
    ...
    user_user      TestPwd123  ReadOnly        ${True}
...
Verify Redfish User with Wrong Password
    ...
    user_user      TestPwd123  ReadOnly        ${True}  12
...
Verify User Creation Without Enabling It
    ...
    user_user      TestPwd123  ReadOnly        ${False}
...
Verify Admin User Privilege
    ...
    Redfish Verify User  user_user  NewTestPwd123  ReadOnly  ${True}
