...
Verify Get ApplyTime
    ...
    ${system_applytime}=  Get ApplyTime
    Valid Value  system_applytime  valid_values=["xyz.openbmc_project.Software.ApplyTime.RequestedApplyTimes.${policy}"]
